...
\footnotetext[1]{Zmiana uchwałą zarzadu z dnia 2 października 2018 o zmianie zakresu prowadzonej działalności gospodarczej}
\begin{para}
 ...
 \begin{enumerate} 
  ...
  \item{ Obróbka mechaniczna elementów metalowych (25.62.Z) \footnotemark[1] }
  \item{ Naprawa i konserwacja urządzeń elektronicznych i optycznych (33.13.Z) \footnotemark[1] }
  \item{ Naprawa i konserwacja urządzeń elektrycznych (33.14.Z) \footnotemark[1] }
  \item{ Wykonywanie instalacji elektrycznych (43.21.Z) \footnotemark[1] }
  \item{ Pozostała działalność wydawnicza (58.19.Z) \footnotemark[1] }
  \item{ Działalność związana z produkcją filmów, nagrań wideo i programów telewizyjnych (59.11.Z) \footnotemark[1] }
  \item{ Działalność związana z oprogramowaniem (62.01.Z) \footnotemark[1] }
  \item{ Działalność związana z doradztwem w zakresie informatyki (62.02.Z) \footnotemark[1] }
  \item{ Pozostała działalność usługowa w zakresie technologii informatycznych i komputerowych (62.09.Z) \footnotemark[1] }
  \item{ Działalność w zakresie specjalistycznego projektowania (74.10.Z) \footnotemark[1] }
  \item{ Działalność pozostałych organizacji członkowskich, gdzie indziej niesklasyfikowana (94.99.Z) \footnotemark[1] }
  \item{ Naprawa i konserwacja komputerów i urządzeń peryferyjnych (95.11.Z) \footnotemark[1] }
  \item{ Naprawa i konserwacja sprzętu (tele)komunikacyjnego (95.12.Z) \footnotemark[1] }
  \item{ Naprawa i konserwacja elektronicznego sprzętu powszechnego użytku (95.21.Z) \footnotemark[1] }
  \item{ Pozostała działalność usługowa, gdzie indziej niesklasyfikowana (96.09.Z) \footnotemark[1] }
 \end{enumerate}
\end{para}
...
\begin{para}
 \begin{enumerate}
  ...
  \item{ Zmiana statutu wymaga opinii Rady Fundacji i zatwierdzenia przez fundatorów. }
