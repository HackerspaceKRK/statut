...
\begin{para}
  ...
  \begin{itemize}
    \item{{\addtolength{\leftskip}{5mm}Marii Magdaleny Skrzypek}}
    \item{{\addtolength{\leftskip}{5mm}Mirosława Ireneusza Woźniaka}}
  \end{itemize}
...
\begin{para}
 \begin{enumerate}
  \item{ Zarząd Fundacji ustanawiany jest na czas nieokreślony. Zarząd stanowią dwie do pięciu osób. Skład Zarządu Fundacji ustanawiany jest na mocy uchwały Rady Fundacji i podlega zatwierdzeniu przez fundatorów. }
  \item{ Pierwszych członków Zarządu powołują fundatorzy. }
  \item{ Następnych członków Zarządu na miejsce osób, które przestały pełnić tę funkcję lub dla rozszerzenia składu powołuje swą decyzją Rada, co podlega zatwierdzeniu przez fundatorów. }
  \item{ W skład Zarządu mogą wchodzić fundatorzy. }
  \item{ Członkostwo w Zarządzie wygasa na skutek śmierci, choroby powodującej trwałą niezdolność do sprawowania funkcji, utraty praw publicznych, zrzeczenia się członkostwa lub odwołania przez Radę Fundacji, co podlega zatwierdzeniu przez fundatorów. }
...
\begin{para}
 \begin{enumerate}
  ...
  \item{ Następnych członków Rady na miejsce osób, które przestały pełnić tę funkcję lub dla rozszerzenia składu powołuje swą decyzją Rada, co podlega zatwierdzeniu przez fundatorów. }
  \item{ Członkostwo w Radzie wygasa, na skutek śmierci, choroby powodującej trwałą niezdolność do sprawowania funkcji, utraty praw publicznych, zrzeczenia się członkostwa lub odwołania decyzją Rady, co podlega zatwierdzeniu przez fundatorów. }
...
\begin{para}
 \begin{enumerate}
  ...
  \item{ Likwidacja Fundacji wymaga opinii Rady Fundacji i zatwierdzenia przez fundatorów. }
