...
\footnotetext[1]{Zmiana uchwałą zarzadu z dnia 29 grudnia 2014 o zmianie siedziby fundacji}
\begin{para}
...
\begin{para}
 ...
 \begin{enumerate}
  \item{ Produkcja elektronicznych obwodów drukowanych (26.12.Z) }
  ...
  \item{ Działalność w zakresie inżynierii i związane z nią doradztwo techniczne (71.12.Z) }
  ...
  \item{ Działalnośc w zakresie telekomunikacji bezprzewodowej, z wyłączeniem telekomunikacji satelitarnej (61.20.Z) }
  \item{ Działalnosc portali internetowych (63.12.Z) }
  \item{ Pozostałe pozaszkolne formy edukacji, gdzie indziej niesklasyfikowane (85.95.B) }
  \item{ Pozostałe doradztwo w zakresie prowadzenia działalności gospodarczej i zarządzania (70.22.Z) }
  \item{ Sprzedaż detaliczna prowadzona przez domy sprzedaży wysyłkowej lub Internet (47.91.Z) }
  \item{ Pozostała działalność profesjonalna, naukowa i techniczna, gdzie indziej niesklasyfikowana (74.90.Z) }
  \item{ Działalność agencji reklamowych (73.11.Z) }
  \item{ Pozostałe badania i analizy techniczne (71.20.B) }
  \item{ Badania naukowe i prace rozwojowe w dziedzinie pozostałych nauk przyrodniczych i technicznych (72.19.Z) }
  \item{ Przetwarzanie danych; zarządzanie stronami internetowymi (hosting) i podobna działalność (63.11.Z) }
  \item{ Działalność agencji informacyjnych (63.91.Z) }
  \item{ Pozostała działalność usługowa w zakresie informacji, gdzie indziej niesklasyfikowana (63.99.Z) }
  \item{ Sprzedaż hurtowa komputerów, urządzeń peryferyjnych i oprogramowania (46.51.Z) }
  \item{ Sprzedaż detaliczna komputerów, urządzeń peryferyjnych i oprogramowania prowadzona w wyspecjalizowanych sklepach (47.41.Z) }
  \item{ Działalność postprodukcyjna związana z filmami, nagraniami wideo i programami telewizyjnymi (59.12.Z) }
  \item{ Działalność związana z dystrybucją filmów, nagrań wideo i programów telewizyjnych (59.13.Z) }
  \item{ Działalność usługowa związana z przygotowywaniem do druku (18.13.Z) }
  \item{ Produkcja narzędzi (25.73.Z) }
  \item{ Produkcja konstrukcji metalowych i ich części (25.11.Z) }
  \item{ Produkcja komputerów i urządzeń peryferyjnych (26.20.Z) }
  \item{ Produkcja sprzętu (tele)komunikacyjnego (26.30.Z) }
  \item{ Produkcja elektronicznego sprzętu powszechnego użytku (26.40.Z) }
  \item{ Produkcja instrumentów i przyrządów pomiarowych, kontrolnych i nawigacyjnych (26.51.Z) }
  \item{ Produkcja zegarków i zegarów (26.52.Z) }
  \item{ Produkcja instrumentów optycznych i sprzętu fotograficznego (26.70.Z) }
  \item{ Produkcja pozostałych elektronicznych i elektrycznych przewodów i kabli (27.32.Z) }
  \item{ Produkcja pozostałego sprzętu elektrycznego (27.90.Z) }
  \item{ Produkcja aparatury rozdzielczej i sterowniczej energii elektrycznej (27.12.Z) }
  \item{ Wykonywanie instalacji elektrycznych (43.21.Z) }
  \item{ Pozostała działalność wydawnicza (58.19.Z) }
  \item{ Produkcja elektrycznego sprzętu oświetleniowego (27.40.Z) }
  \item{ Działalność w zakresie telekomunikacji satelitarnej (61.30.Z) }
  \item{ Działalność w zakresie specjalistycznego projektowania (74.10.Z) }
  \item{ Obróbka mechaniczna elementów metalowych (25.62.Z) }
  \item{ Produkcja sprzętu instalacyjnego (27.33.Z) }
  ...
  \item{ Wynajem i dzierżawa pozostałych maszyn, urządzeń oraz dóbr materialnych, gdzie indziej nie sklasyfikowane (77.39.Z) }
  \item{ Wykonywanie fotokopii, przygotowywanie dokumentów i pozostała specjalistyczna działalność wspomagająca prowadzenie biura (82.19.Z) }
...
\footnotetext[1]{Zmiana uchwałą zarzadu z dnia 29 grudnia 2014 o zmianie sposobu wyboru władz i zmian Statutu}
\begin{para}
 \begin{enumerate}
  \item{ Zarząd Fundacji ustanawiany jest na czas nieokreślony. Zarząd stanowią dwie do pięciu osób. \footnotemark[1] }
  \item{ Pierwszych członków Zarządu powołują fundatorzy. }
  \item{ Następnych członków Zarządu na miejsce osób, które przestały pełnić tę funkcję lub dla rozszerzenia składu powołuje swą decyzją Rada \footnote{Zmieniony uchwałą zarzadu z 29 grudnia 2014 roku o zmianie sposobu wyboru władz}}
  \item{ W skład Zarządu mogą wchodzić fundatorzy. }
  \item{ Członkostwo w Zarządzie wygasa na skutek śmierci, choroby powodującej trwałą niezdolność do sprawowania funkcji, utraty praw publicznych, zrzeczenia się członkostwa lub odwołania przez Radę Fundacji \footnotemark[1] }
...
\begin{para}
 \begin{enumerate}
  ...
  \item{ Następnych członków Rady na miejsce osób, które przestały pełnić tę funkcję lub dla rozszerzenia składu powołuje swą decyzją Rada \footnotemark[1]}
  \item{ Członkostwo w Radzie wygasa, na skutek śmierci, choroby powodującej trwałą niezdolność do sprawowania funkcji, utraty praw publicznych, zrzeczenia się członkostwa lub odwołania decyzją Rady\footnotemark[1] }
...
\begin{para}
 \begin{enumerate}
  ...
  \item{ Likwidacja Fundacji wymaga opinii Rady Fundacji \footnotemark[1] }
